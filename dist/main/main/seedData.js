...
async function seedDatabase() {
    try {
        ...
        // 创建示例 OKRs
        const okr1Id = await databaseService_1.databaseService.createOKR({
            title: '提升个人效率',
        ...
        const okr2Id = await databaseService_1.databaseService.createOKR({
            title: '学习新技术',
        ...
        // 创建示例待办事项
        await databaseService_1.databaseService.createTodo({
            title: '完成项目文档',
        ...
        // 创建示例任务
        await databaseService_1.databaseService.createTask({
            okr_id: okr1Id,
            title: '建立时间管理系统',
        ...
        // 创建示例笔记
        await databaseService_1.databaseService.createNote({
            title: '项目架构思考',
